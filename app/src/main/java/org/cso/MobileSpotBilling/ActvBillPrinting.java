 ...
 */
					...
					builder.addText(String.format("  MF:  %.2f CONSUMPTION:  %.0f\n", mf, consump));
 ...
 */
				...
				else if (UtilAppCommon.out.CD.length() > 0)
				{
					...
					if(UtilAppCommon.out.Category.equalsIgnoreCase("LTIS-ID")
						...
						//Log.v("ActvBillPrinting", "EpsonThermalHindi printing "+CD2+" "+val+" "+ Math.ceil((double)(val/0.9f)));
					}
					else {
						/**
						 * End ading lines for tariff change
        ...
        public void run() {
            ...
            try {
               ...
               /* AnalogicsThermalPrinter conn = new AnalogicsThermalPrinter();
                ...
                printerdata1.append(String.format("SL :%s CL %s\n",CD,CD1));
                printerdata1.append(String.format("CD :%s\n",CD2));
                ...
                printerdata3.append(String.format("MF : %.2f CONSUMPTION:%.2f\n",mf,consump));
                printerdata3.append(String.format("RECORDED DEMD :%s  PF:%s\n",UtilAppCommon.out.RecordedDemd, UtilAppCommon.out.PowerFactor));
                ...
                printerdata3.append(String.format("MMC UNIT:%.2f \n",mmcunits));
    ...
    class TVSHindi extends Thread {
        ...
        public void run() {
            ...
            try {
				...
				printerdata1.append(String.format("स्वीकृत भार   :%s %s\n",CD,CD1));
