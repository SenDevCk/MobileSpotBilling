...
public class InterDupActivity extends AppCompatActivity {
    Toolbar toolbar;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_inter_dup);
		toolbar = findViewById(R.id.toolbar_inter_dup);
	...
	public void performOperation()
	{
		...
		Cursor cursor = util.checkDoubleinSAPInput(lsAccountNo);
		//util.close();
		...
		if (cursor != null)
		{
			...
			try {
				...
				if(cursor.getString(cursor.getColumnIndex("MSGID")).equalsIgnoreCase("1") || cursor.getString(cursor.getColumnIndex("MSGID")).equalsIgnoreCase("2") || cursor.getString(cursor.getColumnIndex("MSGID")).equalsIgnoreCase("7"))
				{
			...
			try {
				if(NetworkUtil.isOnline(InterDupActivity.this,null))
				{
