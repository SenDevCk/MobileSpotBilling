	...
	class EpsonThermal extends Thread {
		...
		public void run() {
			...
			try {
				...
				builder.addTextAlign(Builder.ALIGN_CENTER);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_CODE39 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_CODABAR , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_CODE128 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_CODE93 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_EAN13 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_EAN8 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_GS1_DATABAR_EXPANDED , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_GS1_128 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_GS1_DATABAR_LIMITED , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_GS1_DATABAR_OMNIDIRECTIONAL , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_GS1_DATABAR_TRUNCATED , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_ITF , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_JAN13 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_JAN8 , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_UPC_A , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				builder.addBarcode("015034547330000160026122016000016", Builder.BARCODE_UPC_E , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
				//builder.addBarcode("015034547330000160026122016000016000", Builder. , Builder.HRI_BELOW, Builder.FONT_A, 2, 100);
	...
	class AnalogicThermal extends Thread {
		...
		try {
			 ...
			 AnalogicsThermalPrinter conn= new AnalogicsThermalPrinter();
				...
				//String strBarcodeData = "015034547330000160026122016000016000";
				
				//printerdata1.append(printer.barcode_Code_39_VIP("123456789"));
				
				//printerdata1.append(printer.font_Courier_24_VIP(String.format("     %s\n","barcode_Code_39_VIP")));	
				//printerdata1.append(printer.barcode_Code_39_VIP("015034547330000160026122016000016000"));
				//printerdata1.append(printer.font_Courier_24_VIP(String.format("     %s\n","barcode_Code_128_Alpha_Numerics_VIP")));
				//printerdata1.append(printer.barcode_Code_128_Alpha_Numerics_VIP("0123456789"));
				//printerdata1.append(printer.font_Courier_24_VIP(String.format("\n0123456789\n\n")));
				//printerdata1.append(printer.barcode_Code_128_Alpha_Numerics_VIP("0123456789123456"));
				//printerdata1.append(printer.font_Courier_24_VIP(String.format("\n0123456789123456\n\n")));
				//printerdata1.append(printer.barcode_Code_128_Alpha_Numerics_VIP("01234567891234567890"));
				//printerdata1.append(printer.font_Courier_24_VIP(String.format("\n01234567891234567890\n\n")));
				printerdata1.append(printer.barcode_Code_128_Alpha_Numerics_VIP("01234567891234567890123"));
				printerdata1.append(printer.font_Courier_24_VIP(String.format("\n01234567891234567890123\n\n")));
				//printerdata1.append(printer.barcode_Code_128_Alpha_Numerics_VIP("015034547330000160026122016000016000"));
				//printerdata1.append(printer.font_Courier_24_VIP(String.format("\n\n015034547330000160026122016000016000\n")));
